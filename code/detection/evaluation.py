...
from detection.misc import detection
from detection.misc.log_utils import DictMeter, batch_logging, dict_to_string
from detection.misc.metric import compute_mot_metric_from_det, save_detection_for_evaluation
from detection.misc.utils import listdict_to_dictlist
...
class Evaluator():
    ...
    def compute_epoch_metrics(self):
        ...
        for det_k in self.detection_to_evaluate:
            ...
            if metric_k is None:
                log.warning(f"Metric for {det_k} is None, most likely because there is no detection generated")
                continue
